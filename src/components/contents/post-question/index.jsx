...
export default function QuestionCard({questionContent, handleToggleFollow, handleToggleVotes, voteChanges, usersByContentId, followedUserIds, currentUserId, replies, onUpdateSubmit, onhandleDelete, handleToggleSaved, flag}) {
